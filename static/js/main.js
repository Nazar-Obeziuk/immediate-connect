...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const mobileMenuBackdrop = document.querySelector('.mobile-menu__backdrop'); // добавлен селектор для backdrop
    const mobileMenuCloseButton = document.querySelector('[data-mobile-menu-close]'); // добавлен селектор для кнопки закрытия

    function closeMobileMenu() { // функция для закрытия мобильного меню
    ...
    // Обработчик события клика на элемент с атрибутом data-mobile-menu-toggle
    mobileMenuToggle.addEventListener('click', toggleMobileMenuDialog);

    // Обработчик события клика на backdrop
    mobileMenuBackdrop.addEventListener('click', closeMobileMenu);

    // Обработчик события клика на кнопку закрытия
    if (mobileMenuCloseButton) { // проверка на случай, если кнопка закрытия отсутствует
